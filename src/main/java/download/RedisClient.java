...
public class RedisClient {
    ...
    private Jedis getConnectionToRedis(int dbIndex) {
        Jedis jedis = new Jedis(appProps.getProperty("upstox.compare.redis.host"), Integer.parseInt(appProps.getProperty("upstox.compare.redis.port")));
    ...
    public Map<String, List<String>> getMapFromRedisData() throws IOException {
        ...
        log.info("Radis candle quantity: " + keys.size());
        ...
        log.info("Minutes candle quattity: " + map.size());
        return map;
    }
}
